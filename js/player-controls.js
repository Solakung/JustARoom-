    ...
    const peripheralGlitchEl = document.getElementById('peripheral-glitch');
    const peripheralFigureEl = peripheralGlitchEl ? peripheralGlitchEl.querySelector('.figure') : null;
    const baseFogDensity = 0.028;
    let nextPeripheralGlitchTime = performance.now() + 13000 + Math.random() * 9000;
